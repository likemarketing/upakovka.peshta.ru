...
$APPLICATION->SetPageProperty("title", "ПЕШТА - Наши работы");
...
<h1 class="catalog-section__title pt-3 mb-3">Наши работы</h1>
<div class="section cases-list-section pt-2">
    <?$APPLICATION->IncludeComponent("bitrix:news.list", "cases_list", Array(
