...
<div class="vertical-line">
    <div class="red-block-top padding_mobile_left">
        <div class="uk-container uk-container-large uk-section">
            <div>
                Добиваемся результата и превосходим ожидания<br/>благодаря фундаментальным ценностям Пешты:<br/>вариативности, контролю качества и технологиям
            </div>
        </div>
    </div>
    <div class="uk-container uk-container-large uk-section">
        <div class="uk-margin-medium-bottom uk-margin-medium-top padding_mobile_left" uk-grid>
            <div class="uk-width-1-2@s uk-position-relative">
                <h2 class="fs-36">Вариативность</h2>
                <div class="vertical-line__point-red"></div>
            </div>
            <div class="uk-width-1-2@s fs-18 roboto_font">
                Накопленный опыт и экспертиза помогают нам производить разноплановую продукцию. За счет этого, мы предлагаем вам наиболее выгодный и удобный вариант, полностью отвечающий вашим требованиям.
            </div>
        </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FORM" => "Заявка на тест или пробный заказ",
		"CATEGORY_ID" => "26",
		"ASSIGNED_BY_ID" => "18",
		"STAGE_ID" => "C26:NEW",
		"USERTYPE_FIELD_LIST_ID" => "540",
		"TITLE_TEXT" => "Оставьте заявку на тест или пробный заказ, и наш менеджер свяжется с вами в ближайшие 30 минут, чтобы уточнить детали",
		"USE_CAPTCHA" => "N",
...
<div class="uk-section uk-container uk-container-large uk-margin-medium-top">
    <div class="uk-text-center"><h2 class="fs-36 uk-margin-medium">Решаем любые задачи</h2></div>
...
<?$APPLICATION->IncludeComponent("growtag:main.feedback", "peshta_feedback_footer_NEW1", Array(
	"FROM" => "upakovka.peshta.ru",
		...
		"STAGE_ID" => "C26:NEW",
		"USERTYPE_FIELD_LIST_ID" => "540",
		"TITLE_TEXT" => "Оставьте заявку на тест или пробный заказ, и наш менеджер свяжется с вами в ближайшие 30 минут, чтобы уточнить детали",	// Текст заголовка блока
		"USE_CAPTCHA" => "N",
