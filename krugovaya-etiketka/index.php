...
<?$APPLICATION->IncludeComponent("growtag:news.list", "page_title_new", Array(
    ...
    "IBLOCK_ID" => "64",	// Код информационного блока
...
<div class="uk-container uk-container-large">
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"DESC_TEXT" => "Круговая этикетка изготавливается из БОПП-пленки и оборачивается вокруг тары. Такая этикетка является отличной альтернативой самоклеящейся этикетке и обладает интересными преимуществами, такими как увеличенная площадь, которая открывает  широкие возможности для маркетинга.",
		"DETAIL_URL" => "",
		...
		"TITLE_TEXT" => "Что такое круговая этикетка?",
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">Выгоды круговой этикетки у Пешты</h2>
        <?$APPLICATION->IncludeComponent("growtag:news.list", "vygody_laminata", Array(
            ...
            "FILTER_NAME" => "",	// Фильтр
            "HIDE_LINK_WHEN_NO_DETAIL" => "N",	// Скрывать ссылку, если нет детального описания
            "IBLOCK_ID" => "63",	// Код информационного блока
            "IBLOCK_TYPE" => "laminat",	// Тип информационного блока (используется только для проверки)
            "INCLUDE_IBLOCK_INTO_CHAIN" => "N",	// Включать инфоблок в цепочку навигации
            "INCLUDE_SUBSECTIONS" => "Y",	// Показывать элементы подразделов раздела
            "MESSAGE_404" => "",	// Сообщение для показа (по умолчанию из компонента)
