...
$APPLICATION->SetPageProperty("title", "Система 5S");
$APPLICATION->SetPageProperty("description", "Компания Пешта использует концепцию бережливого производства 5S для систематизации и организации рабочего пространства с целью увеличения производительности и улучшения качества продукции. Система 5S применяется ко всем подразделениям компании.");
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle("Система 5S в Пеште");
?>
<div class="wn-banner">
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">Принципы 5S</h2>
        <div class="" uk-grid>
            <?$APPLICATION->IncludeComponent("growtag:news.list", "principy5s", Array(
                ...
                "IBLOCK_TYPE" => "5sstandarts",	// Тип информационного блока (используется только для проверки)
    ...
    <div class="uk-section uk-padding-remove-top">
        <h2 class="uk-text-center">Результаты для клиентов</h2>
