...
<?$APPLICATION->IncludeComponent("growtag:news.list", "page_title_new", Array(
    ...
    "IBLOCK_ID" => "74",	// Код информационного блока
...
<div class="uk-container uk-container-large">
	...
	array(
		...
		"TITLE_TEXT" => "Преимущества Пешты при печати переменного кода Data Matrix Code",
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">Выгоды Data Matrix Code у Пешты</h2>
