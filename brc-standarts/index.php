...
$APPLICATION->SetPageProperty("description", "Пешта работает по международному стандарту BRC");
$APPLICATION->SetPageProperty("title", "BRC");
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle("BRC");
?>
<div class="wn-banner">
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">Принципы BRC</h2>
        <div class="" uk-grid>
	...
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"IBLOCK_TYPE" => "brcstandarts",	// Тип информационного блока (используется только для проверки)
    ...
    <div class="uk-section">
        <div class="border-radius border_overflow_hide uk-cover-container">
            <img src="<?=SITE_TEMPLATE_PATH?>/images/digital-printing.png" alt="" uk-cover>
            <canvas width="" height="540"></canvas>
        </div>
    </div>
</div>
