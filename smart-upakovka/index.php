...
<?$APPLICATION->IncludeComponent("growtag:news.list", "page_title_new", Array(
    ...
    "IBLOCK_ID" => "79",	// Код информационного блока
...
<div class="uk-container uk-container-large">
	...
	array(
		...
		"TITLE_TEXT" => "Преимущества SMART-упаковки и использования переменного кода на упаковке",
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">Выгоды SMART-упаковки у Пешты</h2>
        <?$APPLICATION->IncludeComponent("growtag:news.list", "vygody_laminata", Array(
            ...
            "FILTER_NAME" => "",	// Фильтр
            "HIDE_LINK_WHEN_NO_DETAIL" => "N",	// Скрывать ссылку, если нет детального описания
            "IBLOCK_ID" => "77",	// Код информационного блока
            "IBLOCK_TYPE" => "laminat",	// Тип информационного блока (используется только для проверки)
            "INCLUDE_IBLOCK_INTO_CHAIN" => "N",	// Включать инфоблок в цепочку навигации
            "INCLUDE_SUBSECTIONS" => "Y",	// Показывать элементы подразделов раздела
            "MESSAGE_404" => "",	// Сообщение для показа (по умолчанию из компонента)
    ...
    <div class="uk-section">
        ...
        <?$APPLICATION->IncludeComponent("growtag:news.list", "vnimanie_k_detalyam", Array(
            ...
            "FILTER_NAME" => "",	// Фильтр
            "HIDE_LINK_WHEN_NO_DETAIL" => "N",	// Скрывать ссылку, если нет детального описания
            "IBLOCK_ID" => "78",	// Код информационного блока
            "IBLOCK_TYPE" => "laminat",	// Тип информационного блока (используется только для проверки)
            "INCLUDE_IBLOCK_INTO_CHAIN" => "N",	// Включать инфоблок в цепочку навигации
            "INCLUDE_SUBSECTIONS" => "Y",	// Показывать элементы подразделов раздела
            "MESSAGE_404" => "",	// Сообщение для показа (по умолчанию из компонента)
    ...
    <div class="uk-section uk-padding-remove-top">
        ...
        <?$APPLICATION->IncludeComponent("growtag:news.list", "primery_rabot_laminat", Array(
            ...
            "FILTER_NAME" => "",	// Фильтр
            "HIDE_LINK_WHEN_NO_DETAIL" => "N",	// Скрывать ссылку, если нет детального описания
            "IBLOCK_ID" => "80",	// Код информационного блока
            "IBLOCK_TYPE" => "laminat",	// Тип информационного блока (используется только для проверки)
            "INCLUDE_IBLOCK_INTO_CHAIN" => "N",	// Включать инфоблок в цепочку навигации
            "INCLUDE_SUBSECTIONS" => "Y",	// Показывать элементы подразделов раздела
            "MESSAGE_404" => "",	// Сообщение для показа (по умолчанию из компонента)
