...
<?// ******************** /User properties ***************************************************
	...
	if ($arResult["USE_CAPTCHA"] == "Y")
	{
		?>
		<tr>
			<td colspan="2"><b style="display: block;text-align: center;margin: 5px;"><?=GetMessage("CAPTCHA_REGF_TITLE")?></b></td>
		</tr>
		<tr>
			<td>
			...
			<td><input class="bx-auth-input m-0" type="text" name="captcha_word" maxlength="50" value="" autocomplete="off" /></td>
		</tr>
		<?
	}
	/* CAPTCHA */
    ...
    <input class="auth-section-button__orange" type="submit" name="Register" value="<?=GetMessage("AUTH_REGISTER")?>" /><br/>
</form>
