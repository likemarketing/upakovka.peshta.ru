            ...
            <div class="index-section-7__form col-md-6 p-5">
                <form action="<?=POST_FORM_ACTION_URI?>" method="POST">
                    ...
                    <div class="index-section-7__form-button mt-4">
                        ...
                        <input title="<?= GetMessage('Нажимая на кнопку вы соглашаетесь с политикой конфиденциальности.') ?>" <?if(strlen($arResult["OK_MESSAGE"]) > 0 || isset($_GET['success'])):?>disabled<?endif;?> type="submit" name="submit" value="<?= GetMessage('Оставить заявку') ?>" class="red-button form-button"/>
                    </div>
                </form>
            </div>
        </div>
