        ...
        <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s" uk-grid>
            ...
            <div>
                <div class="uk-card-body">
                    <h3 class="uk-card-title"><?= GetMessage('Заявка на расчет стоимости') ?></h3>
                    <div class="roboto_font uk-margin">
                        <?= GetMessage('Оставьте заявку на тест или пробный заказ, и наш менеджер свяжется с вами в ближайшее время, чтобы уточнить детали') ?>
                    </div>
                    <form class="form form_modal" action="<?=POST_FORM_ACTION_URI?>" method="POST">
                        ...
                        <div class="uk-margin"><input class="uk-input" type="text" placeholder="<?= GetMessage('Ваш телефон') ?> *" required name="user_phone" value="<?=$arResult["AUTHOR_PHONE"]?>"></div>
                        <div class="uk-margin">
