...
<table class="data-table profile-table">
    ...
    <p><input class="auth-section-button__orange" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class="auth-section-button" type="reset" value="<?=GetMessage('MAIN_RESET');?>"><a class="auth-section-button" href="/personal/">Вернуться</a></p>
</form>
<?endif?>
</div>
