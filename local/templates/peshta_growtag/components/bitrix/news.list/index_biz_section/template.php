        ...
        <div class="catalog-list__item col-md-3 col-sm-6 col-xs-12" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <a href="<?echo $arItem["DETAIL_PAGE_URL"]?>">
                <div class="catalog-list__item-card">
                    ...
                    <!--<a class="catalog-list__item-card-button-modal" href="<?echo $arItem["DETAIL_PAGE_URL"]?>">Подробнее</a>-->
                    <!--<a class="catalog-list__item-card-button-modal" data-toggle="modal" data-target="#staticBackdrop" href="#">Заказать</a>-->
                </div>
            </a>
        </div>
        <?endforeach;?>
