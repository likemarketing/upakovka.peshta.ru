...
<?$APPLICATION->IncludeComponent("growtag:news.list", "page_title_new", Array(
    ...
    "IBLOCK_ID" => "69",	// Код информационного блока
...
<div class="uk-container uk-container-large">
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"DESC_TEXT" => "Гибкая упаковка - полимерная пленка с нанесением на нее изображения. Такая упаковка обладает отличными влагозащитными свойствами и помогает увеличить срок хранения продукта.",
		"DETAIL_URL" => "",
		...
		"TITLE_TEXT" => "Что такое гибкая упаковка?",
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">Выгоды гибкой упаковки у Пешты</h2>
