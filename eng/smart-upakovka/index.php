...
$APPLICATION->SetPageProperty("keywords", GetMessage('smart упаковка, смарт упаковка, умная упаковка, упаковка смарт купить, переменный код, qr код печать'));
$APPLICATION->SetPageProperty("title", GetMessage('Печать переменного кода и SMART-упаковки в Пеште'));
$APPLICATION->SetPageProperty("description", GetMessage('Smart упаковка и печать переменного кода в Пеште. Прямая коммуникация с потребителем, увеличение продаж до 40% с помощью вовлечения клиентов в программы лояльности, расширение активной клиентской базы в десятки ра'));
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle(GetMessage('Переменный код и SMART-упаковка'));
?>
...
<div class="uk-container uk-container-large">
    ...
    array(
        ...
        "SORT_ORDER2" => "ASC",
        "STRICT_SECTION_CHECK" => "N",
        "TITLE_TEXT" => GetMessage('Преимущества SMART-упаковки и использования переменного кода на упаковке'),
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom"><?= GetMessage('Выгоды SMART-упаковки у Пешты') ?></h2>
