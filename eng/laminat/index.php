...
$APPLICATION->SetPageProperty("keywords", GetMessage('Тубный ламинат, тубный ламинат цена, печать на тубах, декорирование туб'));
$APPLICATION->SetPageProperty("title", GetMessage('Печать на тубном ламинате'));
$APPLICATION->SetPageProperty("description", GetMessage('Заказать печать на тубном ламинате.  Короткие и большие тиражи, широкие возможности для декорирования, печать низкомиграционными красками'));
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle(GetMessage('Тубный ламинат'));
?>
