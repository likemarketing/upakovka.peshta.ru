...
$APPLICATION->SetPageProperty("description", "Peshta complies with the BRC global standard (BRCGS)");
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">BRC principles</h2>
        <div class="" uk-grid>
