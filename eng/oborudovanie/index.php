...
$APPLICATION->SetPageProperty("title", GetMessage('Оборудование'));
$APPLICATION->SetPageProperty("description", "");
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle(GetMessage('Оборудование'));
?><div class="wn-banner">
...
<div class="uk-container uk-container-large">
	...
	<div class="uk-section">
		<h2 class="uk-text-center fs-36"><?= GetMessage('А также') ?></h2>
		 <?$APPLICATION->IncludeComponent(
	"growtag:news.list",
	"takzhe",
	Array(
