...
$APPLICATION->SetPageProperty("title", GetMessage('Печать самоклеющихся этикеток в Пеште'));
$APPLICATION->SetPageProperty("description", GetMessage('Печать самоклеющихся этикеток в рулоне. Контроль качества на пяти этапах производства, печать низкомиграционными красками и использование специальных лаков. Печать коротких и больших тиражей'));
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle(GetMessage('Самоклеящаяся этикетка'));
?>
...
<div class="uk-container uk-container-large">
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"DESC_TEXT" => GetMessage('Самоклеящаяся этикетка - это этикетка с клеевым слоем. Такая этикетка является более успешной альтернативой “сухой” этикетке. За счет того, что клеевой слой равномерный и всегда остается вязким, края этикетки не отклеиваются, а на поверхности не остается некрасивых пузырей и неровностей'),
		"DETAIL_URL" => "",
		"DISPLAY_BOTTOM_PAGER" => "N",
		"DISPLAY_DATE" => "N",
		"DISPLAY_NAME" => "Y",
		...
		"SORT_ORDER2" => "ASC",
		"STRICT_SECTION_CHECK" => "N",
		"TITLE_TEXT" => GetMessage('Что такое самоклеящаяся этикетка?'),
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom"><?= GetMessage('Выгоды самоклеящейся этикетки у Пешты') ?></h2>
