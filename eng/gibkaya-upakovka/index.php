...
$APPLICATION->SetPageProperty("description", "Flexible packaging printing in Peshta. Ample opportunities for decoration, printing of short and large runs, departure of specialists to your production");
$APPLICATION->SetPageProperty("keywords", "flexible packaging, flexible packaging film, flexible packaging price, flexible packaging manufacturing, buy flexible packaging, flexible packaging printing");
$APPLICATION->SetPageProperty("title", "Order flexible packaging in Peshta");
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle("Flexible packaging");
?>
...
<div class="uk-container uk-container-large">
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"DESC_TEXT" => "Flexible packaging is a polymer film with a printed image. It boasts excellent moisture-proof properties and extends product shelf life.",
		"DETAIL_URL" => "",
		"DISPLAY_BOTTOM_PAGER" => "N",
		"DISPLAY_DATE" => "N",
		"DISPLAY_NAME" => "Y",
		...
		"SORT_ORDER2" => "ASC",
		"STRICT_SECTION_CHECK" => "N",
		"TITLE_TEXT" => "What is flexible packaging?",
...
<div class="uk-container uk-container-large">
    <div class="uk-section">
        <h2 class="uk-text-center uk-margin-medium-bottom">Pros of our flexible packaging</h2>
...
<?$APPLICATION->IncludeComponent("growtag:main.feedback", "peshta_feedback_footer_NEW1", Array(
    ...
    "TITLE_TEXT" => "See our cases in your business segment",
    "USE_CAPTCHA" => "N",
