...
$APPLICATION->SetPageProperty("description", "Printing IML labels in Peshta. Compliance with standards, strict SLA parameters in terms of quality and timing, prompt delivery to any regions of Russia and CIS countries");
$APPLICATION->SetPageProperty("keywords", "iml printing, iml label, fused label, fused label iml, inmold label");
$APPLICATION->SetPageProperty("title", "Printing IML labels. Fused label in Peshta");
$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");
$APPLICATION->SetTitle("Peshta");
?>
...
<section class="index-section-2">
    <div class="container">
        <div class="row justify-content-center">
            <h2>How the look of packaging with IML<br>(in-mold label) affects<br>customer choice:</h2>
        </div>
        <div class="row">
            ...
            <div class="index-section-3__content">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="content-text col-md-7">
                        This means an in-mold label made using injection-molding technology. As a result of injection molding, it forms one whole unit with the packaging material. The IML label does not deform or fade, it is resistant to moisture and mechanical impacts during transportation, storage and shelf display.<br><br>
...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "SORT_ORDER2" => "ASC",
        "STRICT_SECTION_CHECK" => "N",
        "TITLE_TEXT" => "Pros of in-mold labels for brand owners",
    ),
    false
);?>
<?$APPLICATION->IncludeComponent(
...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "DESC_TEXT" => "Why big manufacturers choose in-mold labels made by PESHTA"
    )
);?>
            ...
            <div class="col-md-8 offset-md-3 p-0">
                <ul class="timeline">
                    ...
                    <li>
                        ...
                        <p>You get a cooperation offer that suits you and your customers best.</p>
                    </li>
                </ul>
            </div>
        </div>
...
<?$APPLICATION->IncludeComponent("growtag:main.feedback", "peshta_iml_modal", Array(
    "FROM" => "upakovka.peshta.ru",
        ...
        "USE_CAPTCHA" => "N",
        "OK_TEXT" => GetMessage('Заявка успешно отправлена. Ожидайте звонка наших менеджеров.'),
        "EMAIL_TO" => "",
        "REQUIRED_FIELDS" => array(
            0 => "NAME",
        ),
...
<?$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "FROM_FIELD_ID" => "UF_CRM_1614519609",
        "USERTYPE_FIELD_ID" => "UF_CRM_1614519142",
        "DEAL_TITLE" => GetMessage('Заявка на подборку с примерами работ'),
        "CATEGORY_ID" => 26,
        "ASSIGNED_BY_ID" => 18,
        "STAGE_ID" => "C26:NEW",
        "USERTYPE_FIELD_LIST_ID" => 540,
