...
$APPLICATION->SetPageProperty("title", "Печать самоклеющихся этикеток в Пеште");
$APPLICATION->SetPageProperty("description", "Печать самоклеющихся этикеток в рулоне. Контроль качества на пяти этапах производства, печать низкомиграционными красками и использование специальных лаков. Печать коротких и больших тиражей");
